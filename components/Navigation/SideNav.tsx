                ...
                <ul>
                    {generalLinks.map((link) => (
                        <li key={link.id} className="flex flex-col items-center mt-2 text-neutral-300 hover:text-white">
                            <div onClick={() => props.setPage(link.name)} className={cn(link.name === props.page ? 'bg-primary/50!' : '', "flex justify-center items-center bg-transparent w-full p-1 h-15 hover:bg-primary/10 rounded-lg cursor-pointer")}>
